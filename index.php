...
@keyframes title-glow {
  ...
  100% {
    filter: drop-shadow(0 10px 30px rgba(231, 106, 4, 0.5));
  }
}
...
.hero-nav {
  ...
  border: 2px solid rgba(231, 106, 4, 0.3);
  color: var(--secondary-color);
  font-size: 1.8rem;
  cursor: pointer;
  z-index: 10;
...
@keyframes nav-pulse {
  0%,
  100% {
    box-shadow: 0 0 20px rgba(231, 106, 4, 0.2);
    transform: translateY(-50%) scale(1);
  }
  50% {
    box-shadow: 0 0 40px rgba(231, 106, 4, 0.4);
...
.hero-nav:hover {
  ...
  color: #fff;
  transform: translateY(-50%) scale(1.2);
  box-shadow: 0 0 60px rgba(231, 106, 4, 0.6);
   ...
   <section class="services-section bg-pattern" id="services">
    ...
    <div class="container">
        <div class="section-header" data-aos="fade-up">
            ...
            <p class="section-subtitle"><?php echo ($lang == 'ar') ? 'نقدّم خدمات توريد أدوات ومستلزمات الأمن والسلامة وفق أعلى المعايير المعتمدة، لتلبية احتياجات المنشآت الصناعية والتجارية والإنشائية، بما يضمن بيئة عمل آمنة ومتوافقة مع اشتراطات السلامة.' : 'We offer a comprehensive range of services specifically designed to meet your needs with high professionalism'; ?></p>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-12">
                <div class="commitment-text text-center" data-aos="fade-up" data-aos-delay="700">
                    <p class="lead mb-0">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6" style="padding-<?php echo ($lang == 'ar') ? 'right' : 'left'; ?>: 40px;">
                <div data-aos="fade-left" data-aos-delay="100">
                    ...
                    <p style="font-size: 1.1rem; color: #6c757d; line-height: 1.8; margin-bottom: 20px;">
                    ...
                    <div style="display: flex; gap: 15px; margin-top: 30px;">
                        ...
                        <a href="contact.php" class="btn-view-all" style="background: #144734ff;" data-aos="fade-up" data-aos-delay="600">
